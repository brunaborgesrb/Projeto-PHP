...
<head>
    ...
    <title>Conversor de Km e Anos-luz</title>
...
<body class="bg-light">
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-3 sidebar py-4"> 
                <img src="{{ asset('images/logo.jpg') }}" alt="Logo Netcon" class="img-fluid">
                <a class="btn btn-primary w-100">KM → ANOS LUZ</a>
                &nbsp
                <a href="/anos-luz-para-km" class="btn btn-primary w-100">ANOS LUZ → KM</a>
            </div>

            <!-- Content -->
            <div class="col-md-9 bg-white p-5 main-content">
                <h2 class="text-center mb-3">Projeto PHP Netcon - Conversor de Km para Anos-luz</h2>

                <!-- Conversão -->
                <div class="convert-section text-center">
                    <label for="inputValue" class="form-label"><strong>Quilômetros:</strong></label>
                    <input 
                        type="number" 
                        id="inputValue" 
    ...
    <script>
        ...
        function convert() {
            ...
            // Fórmula de conversão: 1 Ano-luz = 9.461 trilhões de Km
            $.ajax({
                url : 'api/anosLuz',
                data: {kilometers: inputValue},
                type : 'post',
                dataType : 'json',
                success : function(data){

                // Exibe o resultado no modal
                const resultText = `O valor convertido é: <strong>${data.anoLuz} Anos-luz</strong>`;
